...
export const _Table = ({
  ...
  return (
    <div className="flex w-full border overflow-x-scroll font-DmSans shadow  p-5 bg-white rounded-[20px]">
      <div
        className="table w-full min-w-[48rem]  my-2 text-[#1e1b59] "
      ...
      >
        <div className=" flex  w-full">
          ...
          >
            {showBtn && (
              <div className="rounded-[20px] z-50 border bg-white w-56 flex justify-center items-center p-4 absolute right-[3rem] bottom-0">
                <a
