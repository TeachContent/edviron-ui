      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto ">
          <div className="flex min-h-full items-center justify-center p-4 m-2 sm:items-center sm:p-0 ">
            ...
            >
              <Dialog.Panel
                className={`relative transform  w-full rounded-lg bg-white text-left shadow transition-all  sm:my-8  ${
              ...
              >
                <div
                  className={`bg-white rounded-lg px-4 pt-5 pb-4 sm:p-6 sm:pb-4`}
                >
